...
# 최대 길이 3이내로 규칙 생성
rules <- apriori(Groceries, parameter=list(supp=0.001, conf=0.80, maxlen=3))  #maxlen=3이내 
...
#2개 이상의 내용을 가지고 있는 것 서브셋 만들기 
#원하는 단어가 포함된 서브셋 만들기 

#왼쪽 item 'butter', 'yogurt' 둘 중 하나에 버터나 요거트가 포함된 서브셋
