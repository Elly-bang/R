...
chisq.test(x=smoke$education,y=smoke$smoking)
...
resulr$response2[result$response ==1] <-"1:무응답"
resulr$response2[result$response ==2] <-"2:낮음"
resulr$response2[result$response ==3] <-"3:높음"
