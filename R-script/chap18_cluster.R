...
#각 그룹별 특징 분석
summary(g1) #신장 142~156 안경: 1  
summary(g2) #신장 155~168 안경: 1,2 
summary(g3) #신장 154~169 안경: 2
...
ghc #  150개(그룹을 의미하는 숫자(1~3) 출력 setosa :1, 그외 2,3 )
...
table(result2$cluster)# 각 케이스에 대한 소속 군집수(1,2,3)

result2$centers #각각의 군집을 확인 
