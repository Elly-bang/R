...
# X-squared = 14.2, df = 5, p-value = 0.01439 < 0.05 (귀무가설 기각-> 대립가설 채택)
...
# 귀무가설 : 스포츠음료의 선호도는 없다. 
# 대립가설 : 기대치와 관찰치는 차이가 있다. 
# 대립가설 : 스포츠 음료 종류에 따른 선택에 선호도 차이가 있다. 
#-----------------------------------------
data <- textConnection(
  "스포츠음료종류  관측도수
  1   41
...
#<유의확률 해석>
#유의확률(p-value : 0.0003999)이 0.05미만이기 때문에 유의미한 수준(α=0.05)에서 귀무가설을 기각할 수 있다.대립가설 채택