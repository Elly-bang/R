...
#  fill 옵션 : hwy 변수를 대상으로 drv변수에 색 채우기 (빈도수)
...
qplot(wt, mpg, data=mtcars, color=carb) #단일 색상 적용(진함-연함)
...
p+ geom_count() +geom_smooth(method = "lm") #오차 범위 
