...
# 5. 가설검정 - 두집단 평균 차이검정
t.test(method1_score, method2_score) #p-value = 0.3002
t.test(method1_score, method2_score, alter="two.sided", conf.int=TRUE, conf.level=0.95) #p-value = 0.0411
# p-value = 0.0411 - 두 집단간 평균에 차이가 있다. 

# # 방향성이 있는 연구가설 검정  : method1 > method2
t.test(method1_score, method2_score, alter="greater", conf.int=TRUE, conf.level=0.95) # p-value = 0.9794
# 방향성이 있는 연구가설 검정  : method1 < method2
t.test(method1_score, method2_score, alter="less", conf.int=TRUE, conf.level=0.95) #p-value = 0.02055<0.05
